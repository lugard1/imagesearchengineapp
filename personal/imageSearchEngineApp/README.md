...
# 📖 [Image Search Engine App] <a name="about-project"></a>

> 

**[Image Search Engine App]** This is a vanilla JavaScript based project that enables a user to search for different the images of different things ranging from animals, nature, trees, birds etc.
...
**Just an Input field and search button.**
...
<!-- > Give credit to everyone who inspired your codebase. -->
 Without Microverse Help this project will not be possible at all so I wish to thank Easy tutorials for giving me this kind of insight to learning how to implement this project.
